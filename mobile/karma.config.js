...
module.exports = function(config) {
  config.set({
    ...
    files: [
        ...
        'www/js/sane.js',
        'www/js/modules/module.services.js',
        'www/js/modules/module.controllers.js',
        'www/js/modules/module.directives.js',
        'www/js/modules/module.routing.js',
        'www/js/modules/module.config.js',
        'www/js/services/**/*.js',
